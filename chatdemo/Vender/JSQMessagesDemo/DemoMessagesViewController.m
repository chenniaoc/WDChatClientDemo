...
- (void)viewDidLoad
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(didReceiveMessageNotification:) name:kGLMNotificationMessageNotify object:nil];
...
{
    CMsgPBContent *content = notification.object;
    JSQMessage *newMsg = [JSQMessage messageWithSenderId:kJSQDemoAvatarIdJobs
                                          displayName:kJSQDemoAvatarDisplayNameJobs
                                                 text:content.msgData];
    
    [self.demoData.messages addObject:newMsg];
                      ...
                      date:(NSDate *)date
{
    ...
    [sendService requestWithCompletionBlock:^(id responeObject, NSError *error) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [weakSelf.demoData.messages addObject:message];
